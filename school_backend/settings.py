...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-#=&shg6fvoncb29*e*1a6z6kou#3mq88c#@86m@ln@&z0m41nr')
...
MIDDLEWARE = [
    ...
    'school_app.middleware.MultiTenancyMiddleware',
...
# Fallback to local sqlite if no valid DATABASE_URL found
